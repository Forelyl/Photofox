...
def cool_shuffle(rounds: int, subs: list[str]):
    result = list()
...
def print_and_shuffle (rounds: int, subs: list[str]):
    print(start_text)
    for x in cool_shuffle(rounds, subs):
        print(x)
        
print_and_shuffle(AMOUNT_OF_ROUNDS, subs)