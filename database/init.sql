-- CREATE USER fox WITH PASSWORD 'qweasd12';
...
CREATE TABLE "user" (
    ...
    complaint_score DECIMAL(21, 2) CHECK (complaint_score >= 0) DEFAULT 0,
...
CREATE INDEX search_user_login_index ON "user" (login ASC);
...
GRANT SELECT, UPDATE, INSERT, DELETE ON subscribe           TO fox;
