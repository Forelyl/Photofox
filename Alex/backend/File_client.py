...
class DropBox_client:
    ...
    def __init__(self) -> None:
        ...
        self.__API = 'sl.B2CUZRn0Bp_Szh75cK3j6JIoST91XZYlbTCjWjhHJwm5sCMU9sc4PC6mBjL20VhOTkSBYwRKIwGIcsRFYuEEribGxAvRY6ryEmPMiWExibEqFUmPcdq3Dosl1w-RLhpSsPLm9Z7HH3QPAD0'
